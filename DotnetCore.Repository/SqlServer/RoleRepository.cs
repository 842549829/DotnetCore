...
namespace DotnetCore.Repository.SqlServer
{
    /// <summary>
    /// 角色仓储
    /// </summary>
    public class RoleRepository : SqlRepositoryBase<Guid, MRole>, IRoleRepository
    {
        ...
        public IEnumerable<MRole> QueryRolesByPaging(TRoleCondition condition)
        {
            ...
            string sqlData = "SELECT * FROM Role WHERE 1 = 1 " + sqlCondition + " ORDER BY Id OFFSET @StratRows ROWS FETCH NEXT @PageSize ROWS ONLY;";
