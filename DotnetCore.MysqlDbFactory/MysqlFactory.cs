...
using DotnetCore.Repository.Mysql;
using static DotnetCore.DbCommon.UnitOfWork.DbFactories;

namespace DotnetCore.MysqlDbFactory
{
    /// <summary>
    /// 数据抽象Mysql
    /// </summary>
    public class MysqlFactory : IDbFactory.IDbFactory
    {
        /// <summary>
        /// 链接字符串
        /// </summary>
        public override string DbString => ConnectionString.MySqlDb;
